...
#define T_DIG_0       ((uint8_t)(CARD_TILE_BASE + 19))
#define T_BIG_DOLLAR  ((uint8_t)(CARD_TILE_BASE + 29))
#define FONT_BASE     ((uint8_t)(CARD_TILE_BASE + 30))

/* rank r in 2..14 -> big card glyph; suit s in 0..3 -> pip tile */
#define T_RANK(r) ((uint8_t)(T_RANK_2 + ((r) - 2)))
/* bold 5x7 digit d in 0..9, for emphasised amounts */
#define T_BIG_DIGIT(d) ((uint8_t)(T_DIG_0 + (d)))
#define T_SUIT(s) ((uint8_t)(T_SUIT_SPADE + (s)))
#define T_GLYPH(slot) ((uint8_t)(FONT_BASE + (slot)))

BANKREF_EXTERN(CARD_TILES)
extern const uint8_t CARD_TILES[1312];
